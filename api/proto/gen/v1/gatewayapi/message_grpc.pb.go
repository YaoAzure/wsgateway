...
var BackendService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "v1/gatewayapi/message.proto",
}
...
// All implementations must embed UnimplementedBatchBackendServiceServer
// for forward compatibility.
//
// BatchBackendService 是业务后端可选实现的批量处理服务
// 网关会将同一个BizID的消息聚合后，通过此服务批量发送给业务后端
...
// UnimplementedBatchBackendServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedBatchBackendServiceServer) mustEmbedUnimplementedBatchBackendServiceServer() {}
